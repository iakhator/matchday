...
Revision ID: 7bfa67164a4b
Revises:
Create Date: 2026-08-20 12:04:40.994612
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_fixtures_matchday"), "fixtures", ["matchday"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "position", sqlmodel.sql.sqltypes.AutoString(length=30), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "form", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=True
        ),
        sa.Column("last_synced_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=True),
